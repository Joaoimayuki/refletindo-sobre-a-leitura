export const perguntas = [
    {
        enunciado: "Na escola, o seu profesor passa um trabalho onde os alunos tinham que responder algumas perguntas usando um livro didatico dado, porém, os seus colegas abrem o celular e utilizam inteligencia artificial para responder as peguntas. Qual a sua reação sobre?",
        alternativas: [
            {
    ...
    {
        enunciado: "Vendo essa situação, o professor passou outra atividade, dessa vez os alunos prcisavam fazer a leitura de um livro  escrever um resumo contando a história do livro. Novamente, os seus colegas utilizam a intligencia artificial para fazer o resumo, sem ler o livro",
        alternativas: [
            {
